                ...
                <table className='table-auto w-full border'>
                    ...
                    <tbody>
                        {records?.map((record, index) => {
                            return  (<tr key={index} className='border hover:bg-gray-50'>
                                        ...
                                        <td className="text-center text-sm  my-2">
                                            <div className="flex justify-center items-center">
                                                <div className="mr-2">
                                                    <Link href="#">
                                                        <svg className="w-6 h-6 text-gray-500 hover:text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 12">
